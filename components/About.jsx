...
function About() {
  return (
    ...
    >
      ...
      >
<div>
  Hello! I&apos;m Ahmad Arafat, an AI and cybersecurity focused developer and problem solver.
   Currently, I&apos;m pursuing a Computer Science degree at Middle East University in Jordan.
    I&apos;m a software developer with experience in Python, SQL, and modern web technologies.
     I specialize in machine learning and data analysis using libraries such 
     as scikit-learn and TensorFlow. My knowledge extends to data structures, 
     algorithms, and model evaluation, making me well-versed in building intelligent 
     detection and security systems.
  <br className="sm:block hidden" />
  Let&apos;s collaborate to build intelligent solutions!
</div>
        <div className="w-fit break-words">
          <Link
            href="mailto:ahmad2004arafat@gmail.com"
            target="_blank"
            rel="noreferrer"
        ...
        <Link
          href="document/Ahmad Arafat CV.pdf"
          target="_blank"
          rel="noreferrer"
          className="w-fit"
        >
